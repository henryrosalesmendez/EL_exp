...
#  
#  Description: This script generate a the latex file 'Table4_5_6-Appendix.tex', which contains 
...
#pickle.dump([H,LEN], open('Table4_5_6-Appendix.pkl', 'wb') )

#[H,LEN] = pickle.load(open('Table4_5_6-Appendix.pkl', 'rb'))
...
fout = open("Table4_5_6-Appendix.tex","w")
fout.write("""
